...
public class GameStoreServiceLayer {
    ...
    @Autowired
    public GameStoreServiceLayer(InvoiceRepository invoiceRepo, TaxRepository taxRepo, ProcessingFeeRepository processingFeeRepo, CatalogClient client) {
...
//            Optional<Console> returnVal = consoleRepo.findById(invoiceViewModel.getItemId());
            Console returnVal = client.findConsoleById(invoiceViewModel.getItemId());
...
//            Optional<Game> returnVal = gameRepo.findById(invoiceViewModel.getItemId());
            Game returnVal = client.findGameById(invoiceViewModel.getItemId());
...
//            Optional<TShirt> returnVal = tShirtRepo.findById(invoiceViewModel.getItemId());
            TShirt returnVal = client.findTShirtById(invoiceViewModel.getItemId());
